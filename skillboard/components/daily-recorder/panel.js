...
export class DailyRecorderPanel extends HTMLElement {
    ...
    constructor() {
        ...
        this.paramValues = {};
        this.SKILL_NAME = 'daily-recorder';
    ...
    async loadDb(file) {
        try {
            await this.db.loadFromFile(file, 'daily_recorder.db');
...
customElements.define('daily-recorder-panel', DailyRecorderPanel);
