...
export class LearningSystemPanel extends HTMLElement {
    ...
    constructor() {
        ...
        this.paramValues = {};
        this.SKILL_NAME = 'learning-system';
    ...
    async loadDb(file) {
        try {
            await this.db.loadFromFile(file, 'learning-system.db');
...
customElements.define('learning-system-panel', LearningSystemPanel);
