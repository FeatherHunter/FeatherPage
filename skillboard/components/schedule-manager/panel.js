...
export class ScheduleManagerPanel extends HTMLElement {
    ...
    constructor() {
        ...
        this.paramValues = {};
        this.SKILL_NAME = 'schedule-manager';
    ...
    async loadDb(file) {
        try {
            await this.db.loadFromFile(file, 'schedule_data.db');
...
customElements.define('schedule-manager-panel', ScheduleManagerPanel);
